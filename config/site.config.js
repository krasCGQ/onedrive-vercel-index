...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'kras@hentaios.onmicrosoft.com',
  ...
  email: 'mailto:kras@raphielgang.org',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/KudProject',
    },
    {
      name: 'GitLab',
      link: 'https://gitlab.com/KudProject',
    },
    {
      name: 'Telegram',
      link: 'https://t.me/KudProject',
    },
  ],
